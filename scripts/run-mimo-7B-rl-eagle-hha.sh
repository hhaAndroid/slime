...
LOG_FILE="${LOG_DIR}/mimo-7B-rl-eagle_${TS}.log"
mkdir -p "${LOG_DIR}"
...
CKPT_ARGS=(
   --hf-checkpoint /mnt/shared-storage-user/llmrazor-share/model/MiMo-7B-RL
   #--hf-checkpoint /root/Qwen3-4B-FP8
   --ref-load /mnt/shared-storage-user/llmrazor-share/model/MiMo-7B-RL_torch_dist
   --load ./MiMo-7B-RL-mtp_slime/
   --save ./MiMo-7B-RL-mtp_slime/
   --save-interval 2000
)
...
EVAL_ARGS=(
   --eval-interval 20
   --eval-prompt-data aime /mnt/shared-storage-user/llmrazor-share/data/slime_data/aime-2024/aime-2024.jsonl
...
ray job submit --address="http://127.0.0.1:8265" \
   --submission-id "mimo-7B-rl-eagle_${TS}" \
   --no-wait \
...
RAY_JOB_ID="mimo-7B-rl-eagle_${TS}"
